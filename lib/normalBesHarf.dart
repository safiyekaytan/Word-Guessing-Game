...
class normalBesHarf extends StatefulWidget {
  final String mod;
  normalBesHarf({super.key, required this.mod});

  @override
  State<normalBesHarf> createState() => _normalBesHarfState();
}

class _normalBesHarfState extends State<normalBesHarf> {
  int asilSayi = 5;
