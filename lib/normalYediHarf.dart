...
class normalYediHarf extends StatefulWidget {
  final String mod;
  const normalYediHarf({super.key, required this.mod});

  @override
  State<normalYediHarf> createState() => _normalYediHarfState();
}

class _normalYediHarfState extends State<normalYediHarf> {
  int asilSayi = 7;
