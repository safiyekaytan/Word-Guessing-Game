...
class normalDortHarf extends StatefulWidget {
  final String mod;
  normalDortHarf({super.key, required this.mod});

  @override
  State<normalDortHarf> createState() => _normalDortHarfState();
}

class _normalDortHarfState extends State<normalDortHarf> {
  int asilSayi = 4;
