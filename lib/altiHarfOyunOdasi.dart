...
class altiHarfOyunOdasi extends StatefulWidget {
  ...
  @override
  State<altiHarfOyunOdasi> createState() => _altiHarfOyunOdasiState();
}

class _altiHarfOyunOdasiState extends State<altiHarfOyunOdasi> {
  int asilSayi = 6;
  ...
  void initState() {
    ...
    super.initState();
    colorList1 = [color1, color2, color3, color4, color5, color6];
    colorList2 = [color11, color22, color33, color44, color55, color66];
    colorList3 = [color111, color222, color333, color444, color555, color666];
    colorList4 = [
      color1111,
      color2222,
      color3333,
